classdef baseflow_m1 < forcingTransform_abstract
    ...
    properties (GetAccess=public, SetAccess=protected)
        ...
        % Model Parameters
        %----------------------------------------------------------------
        head_scaler   % time scale parameter [d-1]
...
% user of the available model types. 
    methods(Static)
        ...
        function modelDescription = modelDescription()
           modelDescription = {'Name: baseflow_m1', ...
                               '', ...
    ...
    %% Constructor of the baseflow_m1 class
    
    methods
        function obj = baseflow_m1(bore_ID, forcingData_data,  forcingData_colnames, siteCoordinates, forcingData_reqCols, modelOptions)
...
%             obj = obj@baseflow(bore_ID, forcingData_data,  forcingData_colnames, siteCoordinates, forcingData_reqCols, modelOptions);
        ...
        function [params, param_names] = getParameters(obj)            
           params = [ obj.head_scaler];
           param_names = {'head_scaler'};
        end
        ...
        % as per range of parameters for model_46 in MaRRMOT 
...
%                 head_col = obj.settings.forcingData_colnames(filt,:);
           ...
           % calculate the baseflow 
            obj.variables.baseFlow = obj.variables.head .* obj.head_scaler;
            % Description:  Outflow from a linear reservoir
