classdef derivedForcing_linearUnconstrainedScaling < derivedForcingTransform_abstract
...
%% Construct the model       
        % Constructor
        function obj = derivedForcing_linearUnconstrainedScaling(bore_ID, forcingData_data,  forcingData_colnames, siteCoordinates, forcingData_reqCols, sourceForcingTransformObject, options)
