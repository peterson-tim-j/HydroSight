classdef baseflow_bi_1 < forcingTransform_abstract
    % Defines the behaviour of baseflow according to the GW head and a scaled weighted rate. 
    
    % Detailed explanation goes here
    % Description:  Linear outflow - inflow from a reservoir if a storage threshold is exceeded
...
% user of the available model types. 
    methods(Static)
        ...
        function modelDescription = modelDescription()
           modelDescription = {'baseflow_bi_1', ...
                               '', ...
    ...
    %% Constructor of the baseflow_bi_1 class
    
    methods
        function obj = baseflow_bi_1(bore_ID, forcingData_data,  forcingData_colnames, siteCoordinates, forcingData_reqCols, modelOptions)
...
%                 head_col = obj.settings.forcingData_colnames(filt,:);
            ...
            obj.variables.baseFlow = obj.linear_scaler .* (obj.variables.head - obj.head_threshold);
