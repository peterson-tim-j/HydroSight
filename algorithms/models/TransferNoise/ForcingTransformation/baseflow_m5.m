...
% user of the available model types. 
    methods(Static)
        ...
        function modelDescription = modelDescription()
           modelDescription = {'Name: baseflow_m5', ...
                               '', ...
    ...
    %% Constructor of the baseflow_m5 class
    
    methods
        function obj = baseflow_m5(bore_ID, forcingData_data,  forcingData_colnames, siteCoordinates, forcingData_reqCols, modelOptions)
...
%             obj = obj@baseflow(bore_ID, forcingData_data,  forcingData_colnames, siteCoordinates, forcingData_reqCols, modelOptions);
        ...
        % as per range of parameters for model_22 in MaRRMOT (VIC)
        function [params_upperLimit, params_lowerLimit] = getParameters_physicalLimit(obj)
            params_lowerLimit = [0 ; 1; 1]; 
            params_upperLimit = [1; 5; 2000];
        end
