classdef objectiveFunction_joint4AMALGAM_obj < model_TFN_SW_GW 
...
%% Model constructor
        ...
        function obj = objectiveFunction_joint4AMALGAM_obj(ParGen, AMALGAMPar,Measurement,ModelName,model_object)           
            ...
            objectiveFunction_joint@model_TFN_SW_GW(ParGen(ii,:), Measurement.time_points_head, Measurement.time_points_streamflow, model_object,{})
            
            

[newObjVals, Cg] = objectiveFunction_joint4AMALGAM(ParGen, AMALGAMPar,Measurement,ModelName,model_object)
