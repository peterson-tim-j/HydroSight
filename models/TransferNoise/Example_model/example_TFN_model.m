...
forcingData.colnames = {'YEAR','MONTH','DAY','PRECIP','ET','RevegFrac'};
...
maxObsFreq = 7;
siteCoordinates = {bore_ID, 100, 100; 'PRECIP', 100, 100; 'ET', 100, 100; 'RevegFrac',602, 100};
...
forcingTransform_Precip = {'transformfunction', 'climateTransform_soilMoistureModels'; ...
               'forcingdata', {'precip','PRECIP';'et','ET'}; ...
...
if run7paramModel
    ...
    model_7params = GroundwaterStatisticsToolbox(bore_ID, 'model_TFN', boreDataWL, maxObsFreq, forcingData, siteCoordinates, modelOptions_7params);
...
if run9paramModel
    ...
    model_9params = GroundwaterStatisticsToolbox(bore_ID, 'model_TFN', boreDataWL, maxObsFreq, forcingData, siteCoordinates, modelOptions_9params);
