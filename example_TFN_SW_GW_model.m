...
%                'forcingdata', {'precip','PRECIP';'et','APET'}; ...
%                'outputdata', 'drainage'; ...
%                'options', {'SMSC',2.0,[];'beta',0.0,'';'k_sat',1.0,'';'alpha',0.0,'';'eps',0.0,'fixed'}};

% using 1-layer soil model "climateTransform_soilMoistureModels_v2" allowing beta,
...
%                'forcingdata', {'precip','PRECIP';'et','APET'}; ...
%                'outputdata', 'drainage'; ...
%                'options', {'SMSC',2,[];'k_infilt',Inf,'fixed';'beta',0,'';'k_sat',1,'';'alpha',0,'';'eps',0.0,''; 'interflow_frac',0.0,'fixed'}}; % withouth ('k_infilt',inf,'fixed') k_infilt is set to 1 automatically.. 
...
%                'forcingdata', {'precip','PRECIP';'et','APET'}; ...
%                'outputdata', 'drainage'; ...
%                'options', {'SMSC',2,[];'k_infilt',Inf,'fixed';'beta',0,'';'k_sat',1,'';'alpha',0,'';'eps',0.0,''; 'interflow_frac',0.5,'';'SMSC_interflow',2,'';'alpha_interflow',1,'';'eps_interflow',0,'fixed'; 'beta_interflow',1,'';'k_sat_interflow',1,''; 'PET_scaler_interflow',0,'fixed'; 'gamma_interflow',0,'fixed'}};
...
%                'forcingdata', {'precip','PRECIP';'et','APET'}; ...
%                'outputdata', 'drainage'; ...
%                'options', {'SMSC',2,[];'k_infilt',Inf,'fixed';'beta',0,'';'k_sat',1,'';'alpha',0,'';'eps',0.0,''; 'interflow_frac',0.5,'';'SMSC_interflow',2,'';'alpha_interflow',1,'';'eps_interflow',0,'fixed'; 'beta_interflow',1,'';'k_sat_interflow',1,''; 'PET_scaler_interflow',1,'fixed'; 'gamma_interflow',NaN,'fixed'}};
...
%                'forcingdata', {'precip','PRECIP';'et','APET'}; ...
%                'outputdata', 'drainage'; ...
%                'options', {'SMSC',2,[];'k_infilt',Inf,'fixed';'beta',0,'';'k_sat',1,'';'alpha',0,'';'eps',0.0,''; 'interflow_frac',0.5,'';'SMSC_interflow',2,'';'alpha_interflow',NaN,'fixed';'eps_interflow',0,'fixed'; 'beta_interflow',NaN,'fixed';'k_sat_interflow',NaN,'fixed'; 'PET_scaler_interflow',1,'fixed'; 'gamma_interflow',NaN,'fixed'}};
